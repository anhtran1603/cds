...
import { getEmployee, getLicense, getLicenses } from "../../../helper/api";
...
export default function Page() {
    ...
    useEffect(() => {
        const getData = async () => {
            const lstData = await getLicenses();
            const data = lstData.find(item => item.employeeID == id);
            setLicense(data);
        }
        ...
        <div>
            <div className="flex items-center justify-between ">
                ...
                <div className="flex items-center justify-between gap 4">
                    ...
                    <Button onClick={() => router.push('/dashboard/employee')} className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 mr-3">
                        Quay lại
                    </Button>
                </div>
