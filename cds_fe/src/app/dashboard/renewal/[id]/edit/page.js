...
import { Input, Accordion, AccordionItem, Autocomplete, AutocompleteItem, Image, Spinner, Button, useDisclosure } from '@nextui-org/react';
        ...
        if (isValid) {
            ...
            try {
                ...
                if (rs) {
                    ...
                    router.push('/dashboard/renewal/' + id);
                    // Reset the form
                    setNewApplication({
                        applicationID: '',
                        companyID: '',
